...
set JAVA_HOME=C:\java\openjdk-17.0.18b8
set HADOOP_HOME=C:\java\hadoop-3.4.3
...
@rem set HADOOP_NAMENODE_OPTS=-Dhadoop.security.logger=%HADOOP_SECURITY_LOGGER% -Dhdfs.audit.logger=%HDFS_AUDIT_LOGGER% %HADOOP_NAMENODE_OPTS%
set HADOOP_DATANODE_OPTS=-Dhadoop.security.logger=ERROR,RFAS %HADOOP_DATANODE_OPTS%

set HADOOP_NAMENODE_OPTS=-Dhadoop.security.logger=%HADOOP_SECURITY_LOGGER% -Dhdfs.audit.logger=%HDFS_AUDIT_LOGGER% -Dhadoop.namenode.bindAddress=0.0.0.0 %HADOOP_NAMENODE_OPTS%
...
set JAVA_HOME=C:\java\openjdk-17.0.18b8
set HADOOP_HOME=C:\java\hadoop-3.4.3
set HADOOP_OPTS=%HADOOP_OPTS% --add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.io=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED